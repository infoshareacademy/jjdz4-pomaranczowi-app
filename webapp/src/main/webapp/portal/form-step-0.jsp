...
<div class="alert alert-info" role="alert">
    ...
    <p>Za pomocą naszej aplikacji uzyskasz informacje na temat notowań kursów walut oraz funduszy inwestycyjnych. Będziesz mógł odnaleźć ekstrema dla interesujących Cię wartości dla dowolnego okresu czasu, obejrzeć wykresy oraz je uprościć.</p>
    <hr>
...
<form action="/portal/home" method="post">
    <div class="form-group row">
        <div class="col-sm-10">
            ...
            <select class="form-control" type="text" name="chooseFundOrCurrency" id="chooseFundOrCurrency">
